...
<figure class="blog-figure vertical"><img src="/static/images/blog/hidro-osmosis.webp" alt="Equipo de ósmosis inversa para purificar agua" loading="lazy" style="max-width:380px;"><figcaption>Equipo de ósmosis inversa: agua en EC 0.0-0.1 para armar tu receta exacta desde cero.</figcaption></figure>
<ul>
